...
def referenceAppGitUrl = "ssh://git@gitlab:${PROJECT_NAME}/" + referenceAppgitRepo
def regressionTestGitUrl = "ssh://git@gitlab:29418/${PROJECT_NAME}/" + regressionTestGitRepo
